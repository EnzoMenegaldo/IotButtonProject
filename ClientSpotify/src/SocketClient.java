                                ...
                                while(true) {
                                    ...
                                    if(message != null){
                                        ...
                                        if(message.contains("LONG")){
                                            ...
                                            Runtime.getRuntime().exec("xdotool key space\n");
                                            Runtime.getRuntime().exec("notify-send \'Play/Pause Spotify\'\n");
                                            try{
                                                Thread.sleep(2000);
                                            }catch(Exception e){}
                                            Runtime.getRuntime().exec("killall notify-osd\n");
                                        }

                                        else if(message.contains("DOUBLE")){
                                            System.out.println("Double click");

                                            Runtime.getRuntime().exec("xdotool key Ctrl+Left");
                                            try{
                                                Thread.sleep(500);
                                            }
                                            catch(Exception e){}
                                            ...
                                            Runtime.getRuntime().exec("xdotool key ctrl+Right");
                                        }
